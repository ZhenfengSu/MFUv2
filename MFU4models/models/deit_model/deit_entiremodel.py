...
_HAS_FUSED_ATTN = hasattr(torch.nn.functional, 'scaled_dot_product_attention') #看有没有这个kernel
...
class vit_models(nn.Module):
    ...
    def __init__(self, img_size=224,  patch_size=16, in_chans=3, num_classes=1000, embed_dim=768, depth=12,
        ...
        self.apply(self._init_weights)# Copyright (c) Meta Platforms, Inc. and affiliates.
# All rights reserved.
...
def deit_huge_patch14_52_LS(pretrained=False, img_size=224, pretrained_21k = False,  **kwargs):
    ...
    return model# Copyright (c) Meta Platforms, Inc. and affiliates.
# All rights reserved.
...
#No need to test these two models
# @register_model
