...
# int8
# python gemm_eval.py --shape_row 8192 --shape_col 8192 --plot_mode True --output shape_8192_int8_info.txt --data_type INT8
# python gemm_eval.py --shape_row 8192 --shape_col 8192 --plot_mode True --output shape_8192_fp16_info.txt --data_type FP16
# python gemm_eval.py --shape_row 8192 --shape_col 8192 --plot_mode True --output shape_8192_fp32_info.txt --data_type FP32

# python gemm_eval.py --shape_row 4096 --shape_col 4096 --plot_mode True --output shape_4096_int8_info.txt --data_type INT8
# python gemm_eval.py --shape_row 4096 --shape_col 4096 --plot_mode True --output shape_4096_fp16_info.txt --data_type FP16
# python gemm_eval.py --shape_row 4096 --shape_col 4096 --plot_mode True --output shape_4096_fp32_info.txt --data_type FP32

# python gemm_eval.py --shape_row 16384 --shape_col 16384 --plot_mode True --output shape_16384_int8_info.txt --data_type INT8
# python gemm_eval.py --shape_row 16384 --shape_col 16384 --plot_mode True --output shape_16384_fp16_info.txt --data_type FP16
# python gemm_eval.py --shape_row 16384 --shape_col 16384 --plot_mode True --output shape_16384_fp32_info.txt --data_type FP32
...
python gemm_eval.py --batch_size 40000 --shape_row 40000 --shape_col 40000 --plot_mode True --output shape_40000_fp16_info.txt --data_type FP16
python gemm_eval.py --batch_size 40000 --shape_row 40000 --shape_col 40000 --plot_mode True --output shape_40000_fp32_info.txt --data_type FP32